					...
					<div className='flex mb-12 mt-5'>
						<div className='flex items-center justify-between gap-[70px]'>
							...
							<div className='w-[115px]'>
								<h3 className='mb-4 font-medium text-[20px]'>Asosiy</h3>
								<NavigationMenu>
									<NavigationMenuList className='block'>
										{navList.map(item => (
											<NavigationMenuItem>
												<a className='text-[14px] text-start' href={item.href}>
													{item.label}
												</a>
											</NavigationMenuItem>
										))}
							...
							<div className='w-[120px]'>
								<h3 className='mb-4 font-medium text-[20px] '>Qo’shimcha</h3>
								<NavigationMenu>
									<NavigationMenuList className='block'>
										{navList2.map(item => (
											<NavigationMenuItem >
							...
							<div className='w-[286px] ml-[300px]'>
								<h3 className='mb-4 font-medium text-[20px] '>Biz bilan aloqa</h3>
								<a
									...
									rel='noreferrer'
								>
									<span className=' font-normal text-[25px]'>(+998 71) 200-54-00</span>
								</a>
								<p className='mt-2'>
									<a className='opacity-[70%] text-[14px]' href='https://yandex.uz/maps/-/CDSFMUZd'>
							...
							<ul className='flex gap-4'>
								<li className='inform2-icons'>
									<a href='https://m.youtube.com/@maxway2010'>
										<img src='./public/icons/youtube.svg' alt='youtobe' />
									</a>
								</li>
								<li className='inform2-icons'>
